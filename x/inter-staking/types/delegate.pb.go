...
type SourceChainUnbondingQueue struct {
	ChainID              string                       `protobuf:"bytes,1,opt,name=chainID,proto3" json:"chainID,omitempty"`
	...
	UnbondingDelegations []types1.UnbondingDelegation `protobuf:"bytes,4,rep,name=unbondingDelegations,proto3" json:"unbondingDelegations"`
}

func (m *SourceChainUnbondingQueue) Reset()         { *m = SourceChainUnbondingQueue{} }
func (m *SourceChainUnbondingQueue) String() string { return proto.CompactTextString(m) }
func (*SourceChainUnbondingQueue) ProtoMessage()    {}
func (*SourceChainUnbondingQueue) Descriptor() ([]byte, []int) {
	return fileDescriptor_40a21c29bec4b091, []int{5}
}
func (m *SourceChainUnbondingQueue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SourceChainUnbondingQueue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SourceChainUnbondingQueue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SourceChainUnbondingQueue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SourceChainUnbondingQueue.Merge(m, src)
}
func (m *SourceChainUnbondingQueue) XXX_Size() int {
	return m.Size()
}
func (m *SourceChainUnbondingQueue) XXX_DiscardUnknown() {
	xxx_messageInfo_SourceChainUnbondingQueue.DiscardUnknown(m)
}

var xxx_messageInfo_SourceChainUnbondingQueue proto.InternalMessageInfo

func (m *SourceChainUnbondingQueue) GetChainID() string {
	if m != nil {
		return m.ChainID
	}
	return ""
...
func (m *SourceChainUnbondingQueue) GetClientID() string {
	if m != nil {
		return m.ClientID
	}
	return ""
...
func (m *SourceChainUnbondingQueue) GetLastHeight() uint64 {
	if m != nil {
		return m.LastHeight
	}
	return 0
...
func (m *SourceChainUnbondingQueue) GetUnbondingDelegations() []types1.UnbondingDelegation {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*SourceChainUnbondingQueue)(nil), "celinlim.interstaking.SourceChainUnbondingQueue")
}
...
var fileDescriptor_40a21c29bec4b091 = []byte{
	...
	,
}
...
func (m *SourceChainUnbondingQueue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SourceChainUnbondingQueue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SourceChainUnbondingQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.LastHeight != 0 {
		i = encodeVarintDelegate(dAtA, i, uint64(m.LastHeight))
		i--
		dAtA[i] = 0x18
	}
	if len(m.ClientID) > 0 {
		...
		i = encodeVarintDelegate(dAtA, i, uint64(len(m.ClientID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ChainID) > 0 {
...
func (m *SourceChainUnbondingQueue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.LastHeight != 0 {
		n += 1 + sovDelegate(uint64(m.LastHeight))
	}
	if len(m.UnbondingDelegations) > 0 {
...
func (m *SourceChainUnbondingQueue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SourceChainUnbondingQueue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SourceChainUnbondingQueue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			m.UnbondingDelegations = append(m.UnbondingDelegations, types1.UnbondingDelegation{})
