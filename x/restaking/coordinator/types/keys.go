...
const (
	...
	PendingConsumerAdditionProposalPrefix
...
func PendingConsumerAdditionProposalKey(chainID string) []byte {
	return append([]byte{PendingConsumerAdditionProposalPrefix}, []byte(chainID)...)
}
